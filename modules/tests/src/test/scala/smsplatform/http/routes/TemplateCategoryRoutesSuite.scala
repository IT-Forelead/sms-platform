...
import com.itforelead.smspaltfrom.routes.{SMSTemplateRoutes, TemplateCategoryRoutes, deriveEntityEncoder}
...
import smsplatform.http.routes.SMSTemplateRoutesSuite.{
  authToken,
