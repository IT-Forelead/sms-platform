...
import com.itforelead.smspaltfrom.domain.custom.refinements.Password
import com.itforelead.smspaltfrom.domain.types.{DecryptCipher, EncryptCipher, EncryptedPassword}
import com.itforelead.smspaltfrom.types.PasswordSalt
